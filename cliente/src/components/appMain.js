      ...
      <Router>
        ...
        >
          <Switch>
            ...
            {!this.state.token && <Redirect from="/catalogo" to="/login" exact />}
            {!this.state.token && <Redirect from="/clientes" to="/login" exact />}
            ...
            {this.state.token && <Route path="/catalogo" component={Catalogo} />}
            {this.state.token && <Route path="/clientes" component={Clientes} />}
          </Switch>
        </AuthContext.Provider>
      </Router>
    );
